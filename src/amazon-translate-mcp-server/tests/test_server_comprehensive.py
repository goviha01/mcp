...
class TestServerInitialization:
    ...
    def test_initialize_services_success(self):
        ...
        with patch('awslabs.amazon_translate_mcp_server.server.AWSClientManager') as mock_aws, \
             ...
             patch('awslabs.amazon_translate_mcp_server.server.SecureTranslationService') as mock_secure, \
             ...
             patch('awslabs.amazon_translate_mcp_server.server.WorkflowOrchestrator') as mock_workflow:
...
class TestMCPToolFunctions:
    ...
    async def test_translate_text_success(self):
        ...
        # Mock the secure translation service
    ...
    async def test_translate_text_service_not_initialized(self):
        ...
        with patch.object(server, 'secure_translation_service', None):
            params = server.TranslateTextParams(
                text="Hello world",
                source_language="en",
                target_language="es"
...
class TestTerminologyMCPTools:
    ...
    async def test_create_terminology_success(self):
        ...
        with patch.object(server, 'terminology_manager') as mock_term:
            mock_term.create_terminology.return_value = "arn:aws:translate:us-east-1:123:terminology/tech-terms"
    ...
    async def test_import_terminology_success(self):
        ...
        with patch.object(server, 'terminology_manager') as mock_term, \
            ...
            mock_term.import_terminology.return_value = "arn:aws:translate:us-east-1:123:terminology/imported-terms"
...
class TestWorkflowMCPTools:
    ...
    async def test_smart_translate_workflow_success(self):
        ...
        from awslabs.amazon_translate_mcp_server.workflow_orchestrator import SmartTranslationWorkflowResult
    ...
    async def test_managed_batch_translation_workflow_success(self):
        ...
        from awslabs.amazon_translate_mcp_server.workflow_orchestrator import BatchTranslationWorkflowResult
