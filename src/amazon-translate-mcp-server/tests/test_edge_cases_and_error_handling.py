...
class TestServerCoverage:
    ...
    def test_server_initialization_edge_cases(self):
        ...
        with patch('awslabs.amazon_translate_mcp_server.server.aws_client_manager') as mock_aws, \
            ...
            mock_batch.list_translation_jobs.return_value = {'TextTranslationJobPropertiesList': []}
...
class TestRetryHandlerCoverage:
    ...
    def test_retry_handler_with_custom_exceptions(self):
        ...
        config = RetryConfig(
            max_attempts=2,
            retryable_exceptions=[TranslationError]
        )
...
class TestAwsClientCoverage:
    ...
    def test_aws_client_edge_cases(self):
        ...
        with patch('awslabs.amazon_translate_mcp_server.aws_client.boto3.Session') as mock_session_class:
            mock_session = Mock()
