...
from awslabs.amazon_translate_mcp_server.exceptions import ValidationError, SecurityError
from awslabs.amazon_translate_mcp_server.config import ServerConfig, set_config, reset_config
...
class TestSecureTranslationService:
    ...
    def secure_service(self):
        ...
        with patch('awslabs.amazon_translate_mcp_server.secure_translation_service.AWSClientManager'):
    ...
    def test_audit_logging_integration(self):
        ...
        try:
            with patch('awslabs.amazon_translate_mcp_server.secure_translation_service.AWSClientManager'):
                ...
                with patch.object(service.security_manager.audit_logger, 'log_translation') as mock_log:
                    service.translate_text_secure(
                        text="Hello world",
                        source_language="en",
                        target_language="es",
