    ...
    def test_too_many_target_languages_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Cannot specify more than 10 target languages"):
            JobConfig(
                job_name="test-job",
                source_language_code="en",
                target_language_codes=["es", "fr", "de", "it", "pt", "ru", "ja", "ko", "zh", "ar", "hi"]
            )
...
class TestLanguagePair:
    ...
    def test_same_source_target_raises_error(self):
        ...
        with pytest.raises(ValueError, match="source_language and target_language cannot be the same"):
            LanguagePair(
                source_language="en",
                target_language="en"
            )
...
class TestEnums:
    ...
    def test_content_type_enum(self):
        ...
        assert ContentType.APPLICATION_DOCX.value == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
