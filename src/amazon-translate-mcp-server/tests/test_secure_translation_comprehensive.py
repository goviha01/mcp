...
class TestSecureTranslationServiceInitialization:
    ...
    def test_secure_translation_service_initialization_default(self):
        ...
        with patch('awslabs.amazon_translate_mcp_server.secure_translation_service.get_config') as mock_config, \
             patch('awslabs.amazon_translate_mcp_server.secure_translation_service.SecurityManager') as mock_security, \
             patch('awslabs.amazon_translate_mcp_server.secure_translation_service.AWSClientManager') as mock_aws:
...
class TestSecureTranslationMethods:
    ...
    def test_translate_text_secure_validation_error(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.side_effect = ValidationError("Invalid input")
    ...
    def test_translate_text_secure_pii_detected(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.return_value = ("Hello [EMAIL]", pii_findings)
        service.security_manager.validator.validate_language_code.side_effect = lambda x, _: x
        service.security_manager.validator.validate_terminology_names.return_value = []
        service.security_manager.log_operation = Mock()
    ...
    def test_translate_text_secure_translation_error(self, service):
        ...
        with patch.object(service, '_perform_translation', side_effect=Exception("Translation service error")):
            service.security_manager.log_operation = Mock()
    ...
    def test_detect_language_secure_with_pii(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.return_value = ("Hello [PHONE]", pii_findings)
        service.security_manager.log_operation = Mock()
...
class TestSecureTranslationErrorHandling:
    ...
    def test_handle_security_error(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.side_effect = SecurityError("Security violation detected")
    ...
    def test_handle_unexpected_error(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.side_effect = RuntimeError("Unexpected error")
...
class TestSecureTranslationAuditLogging:
    ...
    def test_audit_logging_with_security_events(self, service):
        ...
        service.security_manager.validate_and_sanitize_text.return_value = ("[EMAIL]", pii_findings)
        service.security_manager.validator.validate_language_code.side_effect = lambda x, _: x
        service.security_manager.validator.validate_terminology_names.return_value = []
        service.security_manager.log_operation = Mock()
