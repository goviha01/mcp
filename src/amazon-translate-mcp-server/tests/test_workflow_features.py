...
class TestWorkflowParameterValidation:
    ...
    def test_managed_batch_translation_workflow_params(self):
        ...
        from awslabs.amazon_translate_mcp_server.server import ManagedBatchTranslationWorkflowParams
...
class TestWorkflowOrchestrator:
    ...
    async def test_smart_translate_workflow_success(self, workflow_orchestrator, mock_services):
        ...
        mock_services['translation_service'].detect_language.return_value = LanguageDetectionResult(
            detected_language="fr",
            confidence_score=0.95,
            alternative_languages=[("es", 0.05)]
        )
    ...
    @pytest.mark.asyncio
    async def test_smart_translate_workflow_unsupported_language_pair(self, workflow_orchestrator, mock_services):
