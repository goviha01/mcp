...
class TestLoadConfigFromEnv:
    ...
    def test_load_config_from_env_aws_credentials(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert config.aws_secret_access_key == 'secret456'
...
class TestValidateAwsConfig:
    ...
    def test_validate_aws_config_incomplete_access_keys(self):
        ...
        config = ServerConfig(aws_access_key_id="AKIATEST123")
        ...
        config = ServerConfig(aws_secret_access_key="secret456")
...
class TestConfigValidationEdgeCases:
    ...
    def test_config_with_special_characters_in_strings(self):
        ...
        config = ServerConfig(
            aws_profile="test-profile_123",
            blocked_patterns=["*.tmp", "temp_*", "cache-*.dat"]
        )
